...
$(function(){
	   $("a#signinFun").click(function(){
		 //alert($("input#idFun").val().length);
	 	  if($("input#idFun").val().length==0||$("input#pwFun").val().length==0){
			  alert('Id Or PassCheck');
			  $("input#idFun").val('');
			  $("input#pwFun").val('');
		  }else{
		 	 $("form#loginFun").submit();
		  }
	   });
});
</script>
	...
	<div class="container" style="margin-top: 120px">
		<div class="row">
			<div class="main">
				...
				<form action="/orm/LoginFun.do" name="loginFun" method="post" id="loginFun">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<a href="#" class="btn btn-sm btn-danger btn-block" id="signinFun">SIGN IN</a>
						</div>
					</div>
					<div class="login-or">
						<hr class="hr-or">
