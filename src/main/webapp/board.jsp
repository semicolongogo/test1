...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="board-field">
		...
		<div class="col-md-8">
			...
			<!-- NO	SUBJECT	AUTHOR	PASSWORD	CONTENTS	HIT	FILENAME	REGDATE -->	
	
			
			<div class="list-group">
			<c:forEach var="i" items="${bootList}" varStatus="cnt">
				<a href="hitboard.do?no=${i.no}" class="list-group-item">
					<div class="board-title">
						<span class="board-category">[MSG]</span>
						<img alt="" src="/orm/upload/${i.fileName}" width="20" height="20">
							${i.subject} <span class="badge">New</span>
					</div>
					<div class="board-meta"	style="font-weight: 400; font-size: 1.2rem; color: #404040">
						<p>
							<i class="glyphicon glyphicon-user">${i.author}</i>
							<i class="glyphicon glyphicon-comment"></i>0
							<i class="glyphicon glyphicon-ok">${i.hit}</i>
							<i class="glyphicon glyphicon-time">${i.regdate}</i>
						</p>
					</div>
				</a>
				</c:forEach>				
