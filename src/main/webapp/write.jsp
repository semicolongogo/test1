...
<body>
	...
	<form action="bootInsert.do" method="post" enctype="multipart/form-data">
	<div id="write-field">
		...
		<div class="col-md-6">
						...
						<div class="row row-xs-bskr">
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								...
								<div class="input-forms">
									<input size="20" type="text" name="author" value=""
			...
			<div class="form-group">
				<table>
					<tr>
						<td class="td1"></td>
						<td calss="td2"><textarea class="form-control col-sm-5" name="contents"
								rows="20"></textarea></td>
					</tr>
					<tr>
					<td class="td1"></td>
