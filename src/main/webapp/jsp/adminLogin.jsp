...
<body>
<form name="login" method="post" action="/orm/loginCheck.do">
 <div id="loginWrapper">
  <div class="loginForm">
   <fieldset>
    <legend>관리자 시스템 로그인</legend>
    <dl>
     <dt><img src="/orm/img/common/th_id.gif" alt="아이디" /></dt>
     <dd><input type="text" name="id" class="text" id="id" value="${idCheck}"/></dd>

     <dt><img src="/orm/img/common/th_pw.gif" alt="비밀번호" /></dt>
    ...
    <div class="saveId"><input type="checkbox" id="checker" name="checker" /> 
     <img src="/orm/img/common/save_id.gif" alt="아이디 저장" />
    </div>
   </fieldset>
  </div>
 </div>
